package project.utils.widget.toolbar
...
open class WaterfallToolbar : CardView {
    ...
    private val nestedScrollViewScrollListener: ViewTreeObserver.OnScrollChangedListener =
        ViewTreeObserver.OnScrollChangedListener {
